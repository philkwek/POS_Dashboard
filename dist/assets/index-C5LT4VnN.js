 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var vv;function nw(){if(vv)return Te;vv=1;var r=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),f=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),S=Symbol.for("react.activity"),w=Symbol.iterator;function P(M){return M===null||typeof M!="object"?null:(M=w&&M[w]||M["@@iterator"],typeof M=="function"?M:null)}var Q={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},J=Object.assign,K={};function ee(M,Z,re){this.props=M,this.context=Z,this.refs=K,this.updater=re||Q}ee.prototype.isReactComponent={},ee.prototype.setState=function(M,Z){if(typeof M!="object"&&typeof M!="function"&&M!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,M,Z,"setState")},ee.prototype.forceUpdate=function(M){this.updater.enqueueForceUpdate(this,M,"forceUpdate")};function ae(){}ae.prototype=ee.prototype;function se(M,Z,re){this.props=M,this.context=Z,this.refs=K,this.updater=re||Q}var de=se.prototype=new ae;de.constructor=se,J(de,ee.prototype),de.isPureReactComponent=!0;var ge=Array.isArray;function ve(){}var I={H:null,A:null,T:null,S:null},b=Object.prototype.hasOwnProperty;function N(M,Z,re){var oe=re.ref;return{$$typeof:r,type:M,key:Z,ref:oe!==void 0?oe:null,props:re}}function x(M,Z){return N(M.type,Z,M.props)}function O(M){return typeof M=="object"&&M!==null&&M.$$typeof===r}function k(M){var Z={"=":"=0",":":"=2"};return"$"+M.replace(/[=:]/g,function(re){return Z[re]})}var R=/\/+/g;function We(M,Z){return typeof M=="object"&&M!==null&&M.key!=null?k(""+M.key):Z.toString(36)}function $e(M){switch(M.status){case"fulfilled":return M.value;case"rejected":throw M.reason;default:switch(typeof M.status=="string"?M.then(ve,ve):(M.status="pending",M.then(function(Z){M.status==="pending"&&(M.status="fulfilled",M.value=Z)},function(Z){M.status==="pending"&&(M.status="rejected",M.reason=Z)})),M.status){case"fulfilled":return M.value;case"rejected":throw M.reason}}throw M}function Y(M,Z,re,oe,Ee){var Re=typeof M;(Re==="undefined"||Re==="boolean")&&(M=null);var ke=!1;if(M===null)ke=!0;else switch(Re){case"bigint":case"string":case"number":ke=!0;break;case"object":switch(M.$$typeof){case r:case e:ke=!0;break;case E:return ke=M._init,Y(ke(M._payload),Z,re,oe,Ee)}}if(ke)return Ee=Ee(M),ke=oe===""?"."+We(M,0):oe,ge(Ee)?(re="",ke!=null&&(re=ke.replace(R,"$&/")+"/"),Y(Ee,Z,re,"",function(ms){return ms})):Ee!=null&&(O(Ee)&&(Ee=x(Ee,re+(Ee.key==null||M&&M.key===Ee.key?"":(""+Ee.key).replace(R,"$&/")+"/")+ke)),Z.push(Ee)),1;ke=0;var Nt=oe===""?".":oe+":";if(ge(M))for(var rt=0;rt<M.length;rt++)oe=M[rt],Re=Nt+We(oe,rt),ke+=Y(oe,Z,re,Re,Ee);else if(rt=P(M),typeof rt=="function")for(M=rt.call(M),rt=0;!(oe=M.next()).done;)oe=oe.value,Re=Nt+We(oe,rt++),ke+=Y(oe,Z,re,Re,Ee);else if(Re==="object"){if(typeof M.then=="function")return Y($e(M),Z,re,oe,Ee);throw Z=String(M),Error("Objects are not valid as a React child (found: "+(Z==="[object Object]"?"object with keys {"+Object.keys(M).join(", ")+"}":Z)+"). If you meant to render a collection of children, use an array instead.")}return ke}function ie(M,Z,re){if(M==null)return M;var oe=[],Ee=0;return Y(M,oe,"","",function(Re){return Z.call(re,Re,Ee++)}),oe}function me(M){if(M._status===-1){var Z=M._result;Z=Z(),Z.then(function(re){(M._status===0||M._status===-1)&&(M._status=1,M._result=re)},function(re){(M._status===0||M._status===-1)&&(M._status=2,M._result=re)}),M._status===-1&&(M._status=0,M._result=Z)}if(M._status===1)return M._result.default;throw M._result}var Ue=typeof reportError=="function"?reportError:function(M){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Z=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof M=="object"&&M!==null&&typeof M.message=="string"?String(M.message):String(M),error:M});if(!window.dispatchEvent(Z))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",M);return}console.error(M)},Fe={map:ie,forEach:function(M,Z,re){ie(M,function(){Z.apply(this,arguments)},re)},count:function(M){var Z=0;return ie(M,function(){Z++}),Z},toArray:function(M){return ie(M,function(Z){return Z})||[]},only:function(M){if(!O(M))throw Error("React.Children.only expected to receive a single React element child.");return M}};return Te.Activity=S,Te.Children=Fe,Te.Component=ee,Te.Fragment=n,Te.Profiler=o,Te.PureComponent=se,Te.StrictMode=s,Te.Suspense=p,Te.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=I,Te.__COMPILER_RUNTIME={__proto__:null,c:function(M){return I.H.useMemoCache(M)}},Te.cache=function(M){return function(){return M.apply(null,arguments)}},Te.cacheSignal=function(){return null},Te.cloneElement=function(M,Z,re){if(M==null)throw Error("The argument must be a React element, but you passed "+M+".");var oe=J({},M.props),Ee=M.key;if(Z!=null)for(Re in Z.key!==void 0&&(Ee=""+Z.key),Z)!b.call(Z,Re)||Re==="key"||Re==="__self"||Re==="__source"||Re==="ref"&&Z.ref===void 0||(oe[Re]=Z[Re]);var Re=arguments.length-2;if(Re===1)oe.children=re;else if(1<Re){for(var ke=Array(Re),Nt=0;Nt<Re;Nt++)ke[Nt]=arguments[Nt+2];oe.children=ke}return N(M.type,Ee,oe)},Te.createContext=function(M){return M={$$typeof:f,_currentValue:M,_currentValue2:M,_threadCount:0,Provider:null,Consumer:null},M.Provider=M,M.Consumer={$$typeof:u,_context:M},M},Te.createElement=function(M,Z,re){var oe,Ee={},Re=null;if(Z!=null)for(oe in Z.key!==void 0&&(Re=""+Z.key),Z)b.call(Z,oe)&&oe!=="key"&&oe!=="__self"&&oe!=="__source"&&(Ee[oe]=Z[oe]);var ke=arguments.length-2;if(ke===1)Ee.children=re;else if(1<ke){for(var Nt=Array(ke),rt=0;rt<ke;rt++)Nt[rt]=arguments[rt+2];Ee.children=Nt}if(M&&M.defaultProps)for(oe in ke=M.defaultProps,ke)Ee[oe]===void 0&&(Ee[oe]=ke[oe]);return N(M,Re,Ee)},Te.createRef=function(){return{current:null}},Te.forwardRef=function(M){return{$$typeof:m,render:M}},Te.isValidElement=O,Te.lazy=function(M){return{$$typeof:E,_payload:{_status:-1,_result:M},_init:me}},Te.memo=function(M,Z){return{$$typeof:y,type:M,compare:Z===void 0?null:Z}},Te.startTransition=function(M){var Z=I.T,re={};I.T=re;try{var oe=M(),Ee=I.S;Ee!==null&&Ee(re,oe),typeof oe=="object"&&oe!==null&&typeof oe.then=="function"&&oe.then(ve,Ue)}catch(Re){Ue(Re)}finally{Z!==null&&re.types!==null&&(Z.types=re.types),I.T=Z}},Te.unstable_useCacheRefresh=function(){return I.H.useCacheRefresh()},Te.use=function(M){return I.H.use(M)},Te.useActionState=function(M,Z,re){return I.H.useActionState(M,Z,re)},Te.useCallback=function(M,Z){return I.H.useCallback(M,Z)},Te.useContext=function(M){return I.H.useContext(M)},Te.useDebugValue=function(){},Te.useDeferredValue=function(M,Z){return I.H.useDeferredValue(M,Z)},Te.useEffect=function(M,Z){return I.H.useEffect(M,Z)},Te.useEffectEvent=function(M){return I.H.useEffectEvent(M)},Te.useId=function(){return I.H.useId()},Te.useImperativeHandle=function(M,Z,re){return I.H.useImperativeHandle(M,Z,re)},Te.useInsertionEffect=function(M,Z){return I.H.useInsertionEffect(M,Z)},Te.useLayoutEffect=function(M,Z){return I.H.useLayoutEffect(M,Z)},Te.useMemo=function(M,Z){return I.H.useMemo(M,Z)},Te.useOptimistic=function(M,Z){return I.H.useOptimistic(M,Z)},Te.useReducer=function(M,Z,re){return I.H.useReducer(M,Z,re)},Te.useRef=function(M){return I.H.useRef(M)},Te.useState=function(M){return I.H.useState(M)},Te.useSyncExternalStore=function(M,Z,re){return I.H.useSyncExternalStore(M,Z,re)},Te.useTransition=function(){return I.H.useTransition()},Te.version="19.2.5",Te}var Ev;function np(){return Ev||(Ev=1,Wd.exports=nw()),Wd.exports}var B=np(),em={exports:{}},Dl={},tm={exports:{}},nm={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tv;function iw(){return Tv||(Tv=1,(function(r){function e(Y,ie){var me=Y.length;Y.push(ie);e:for(;0<me;){var Ue=me-1>>>1,Fe=Y[Ue];if(0<o(Fe,ie))Y[Ue]=ie,Y[me]=Fe,me=Ue;else break e}}function n(Y){return Y.length===0?null:Y[0]}function s(Y){if(Y.length===0)return null;var ie=Y[0],me=Y.pop();if(me!==ie){Y[0]=me;e:for(var Ue=0,Fe=Y.length,M=Fe>>>1;Ue<M;){var Z=2*(Ue+1)-1,re=Y[Z],oe=Z+1,Ee=Y[oe];if(0>o(re,me))oe<Fe&&0>o(Ee,re)?(Y[Ue]=Ee,Y[oe]=me,Ue=oe):(Y[Ue]=re,Y[Z]=me,Ue=Z);else if(oe<Fe&&0>o(Ee,me))Y[Ue]=Ee,Y[oe]=me,Ue=oe;else break e}}return ie}function o(Y,ie){var me=Y.sortIndex-ie.sortIndex;return me!==0?me:Y.id-ie.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var f=Date,m=f.now();r.unstable_now=function(){return f.now()-m}}var p=[],y=[],E=1,S=null,w=3,P=!1,Q=!1,J=!1,K=!1,ee=typeof setTimeout=="function"?setTimeout:null,ae=typeof clearTimeout=="function"?clearTimeout:null,se=typeof setImmediate<"u"?setImmediate:null;function de(Y){for(var ie=n(y);ie!==null;){if(ie.callback===null)s(y);else if(ie.startTime<=Y)s(y),ie.sortIndex=ie.expirationTime,e(p,ie);else break;ie=n(y)}}function ge(Y){if(J=!1,de(Y),!Q)if(n(p)!==null)Q=!0,ve||(ve=!0,k());else{var ie=n(y);ie!==null&&$e(ge,ie.startTime-Y)}}var ve=!1,I=-1,b=5,N=-1;function x(){return K?!0:!(r.unstable_now()-N<b)}function O(){if(K=!1,ve){var Y=r.unstable_now();N=Y;var ie=!0;try{e:{Q=!1,J&&(J=!1,ae(I),I=-1),P=!0;var me=w;try{t:{for(de(Y),S=n(p);S!==null&&!(S.expirationTime>Y&&x());){var Ue=S.callback;if(typeof Ue=="function"){S.callback=null,w=S.priorityLevel;var Fe=Ue(S.expirationTime<=Y);if(Y=r.unstable_now(),typeof Fe=="function"){S.callback=Fe,de(Y),ie=!0;break t}S===n(p)&&s(p),de(Y)}else s(p);S=n(p)}if(S!==null)ie=!0;else{var M=n(y);M!==null&&$e(ge,M.startTime-Y),ie=!1}}break e}finally{S=null,w=me,P=!1}ie=void 0}}finally{ie?k():ve=!1}}}var k;if(typeof se=="function")k=function(){se(O)};else if(typeof MessageChannel<"u"){var R=new MessageChannel,We=R.port2;R.port1.onmessage=O,k=function(){We.postMessage(null)}}else k=function(){ee(O,0)};function $e(Y,ie){I=ee(function(){Y(r.unstable_now())},ie)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(Y){Y.callback=null},r.unstable_forceFrameRate=function(Y){0>Y||125<Y?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<Y?Math.floor(1e3/Y):5},r.unstable_getCurrentPriorityLevel=function(){return w},r.unstable_next=function(Y){switch(w){case 1:case 2:case 3:var ie=3;break;default:ie=w}var me=w;w=ie;try{return Y()}finally{w=me}},r.unstable_requestPaint=function(){K=!0},r.unstable_runWithPriority=function(Y,ie){switch(Y){case 1:case 2:case 3:case 4:case 5:break;default:Y=3}var me=w;w=Y;try{return ie()}finally{w=me}},r.unstable_scheduleCallback=function(Y,ie,me){var Ue=r.unstable_now();switch(typeof me=="object"&&me!==null?(me=me.delay,me=typeof me=="number"&&0<me?Ue+me:Ue):me=Ue,Y){case 1:var Fe=-1;break;case 2:Fe=250;break;case 5:Fe=1073741823;break;case 4:Fe=1e4;break;default:Fe=5e3}return Fe=me+Fe,Y={id:E++,callback:ie,priorityLevel:Y,startTime:me,expirationTime:Fe,sortIndex:-1},me>Ue?(Y.sortIndex=me,e(y,Y),n(p)===null&&Y===n(y)&&(J?(ae(I),I=-1):J=!0,$e(ge,me-Ue))):(Y.sortIndex=Fe,e(p,Y),Q||P||(Q=!0,ve||(ve=!0,k()))),Y},r.unstable_shouldYield=x,r.unstable_wrapCallback=function(Y){var ie=w;return function(){var me=w;w=ie;try{return Y.apply(this,arguments)}finally{w=me}}}})(nm)),nm}var Sv;function rw(){return Sv||(Sv=1,tm.exports=iw()),tm.exports}var im={exports:{}},Yt={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R2="__/auth/handler",I2="emulator/auth/handler",C2=encodeURIComponent("fac");async function o0(r,e,n,s,o,u){_e(r.config.authDomain,r,"auth-domain-config-required"),_e(r.config.apiKey,r,"invalid-api-key");const f={apiKey:r.config.apiKey,appName:r.name,authType:n,redirectUrl:s,v:ia,eventId:o};if(e instanceof bT){e.setDefaultLanguage(r.languageCode),f.providerId=e.providerId||"",hR(e.getCustomParameters())||(f.customParameters=JSON.stringify(e.getCustomParameters()));for(const[E,S]of Object.entries({}))f[E]=S}if(e instanceof su){const E=e.getScopes().filter(S=>S!=="");E.length>0&&(f.scopes=E.join(","))}r.tenantId&&(f.tid=r.tenantId);const m=f;for(const E of Object.keys(m))m[E]===void 0&&delete m[E];const p=await r._getAppCheckToken(),y=p?`#${C2}=${encodeURIComponent(p)}`:"";return`${N2(r)}?${nu(m).slice(1)}${y}`}function N2({config:r}){return r.emulator?mp(r,I2):`https://${r.authDomain}/${R2}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var ts,sS;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(I,b){function N(){}N.prototype=b.prototype,I.F=b.prototype,I.prototype=new N,I.prototype.constructor=I,I.D=function(x,O,k){for(var R=Array(arguments.length-2),We=2;We<arguments.length;We++)R[We-2]=arguments[We];return b.prototype[O].apply(x,R)}}function n(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(s,n),s.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(I,b,N){N||(N=0);const x=Array(16);if(typeof b=="string")for(var O=0;O<16;++O)x[O]=b.charCodeAt(N++)|b.charCodeAt(N++)<<8|b.charCodeAt(N++)<<16|b.charCodeAt(N++)<<24;else for(O=0;O<16;++O)x[O]=b[N++]|b[N++]<<8|b[N++]<<16|b[N++]<<24;b=I.g[0],N=I.g[1],O=I.g[2];let k=I.g[3],R;R=b+(k^N&(O^k))+x[0]+3614090360&4294967295,b=N+(R<<7&4294967295|R>>>25),R=k+(O^b&(N^O))+x[1]+3905402710&4294967295,k=b+(R<<12&4294967295|R>>>20),R=O+(N^k&(b^N))+x[2]+606105819&4294967295,O=k+(R<<17&4294967295|R>>>15),R=N+(b^O&(k^b))+x[3]+3250441966&4294967295,N=O+(R<<22&4294967295|R>>>10),R=b+(k^N&(O^k))+x[4]+4118548399&4294967295,b=N+(R<<7&4294967295|R>>>25),R=k+(O^b&(N^O))+x[5]+1200080426&4294967295,k=b+(R<<12&4294967295|R>>>20),R=O+(N^k&(b^N))+x[6]+2821735955&4294967295,O=k+(R<<17&4294967295|R>>>15),R=N+(b^O&(k^b))+x[7]+4249261313&4294967295,N=O+(R<<22&4294967295|R>>>10),R=b+(k^N&(O^k))+x[8]+1770035416&4294967295,b=N+(R<<7&4294967295|R>>>25),R=k+(O^b&(N^O))+x[9]+2336552879&4294967295,k=b+(R<<12&4294967295|R>>>20),R=O+(N^k&(b^N))+x[10]+4294925233&4294967295,O=k+(R<<17&4294967295|R>>>15),R=N+(b^O&(k^b))+x[11]+2304563134&4294967295,N=O+(R<<22&4294967295|R>>>10),R=b+(k^N&(O^k))+x[12]+1804603682&4294967295,b=N+(R<<7&4294967295|R>>>25),R=k+(O^b&(N^O))+x[13]+4254626195&4294967295,k=b+(R<<12&4294967295|R>>>20),R=O+(N^k&(b^N))+x[14]+2792965006&4294967295,O=k+(R<<17&4294967295|R>>>15),R=N+(b^O&(k^b))+x[15]+1236535329&4294967295,N=O+(R<<22&4294967295|R>>>10),R=b+(O^k&(N^O))+x[1]+4129170786&4294967295,b=N+(R<<5&4294967295|R>>>27),R=k+(N^O&(b^N))+x[6]+3225465664&4294967295,k=b+(R<<9&4294967295|R>>>23),R=O+(b^N&(k^b))+x[11]+643717713&4294967295,O=k+(R<<14&4294967295|R>>>18),R=N+(k^b&(O^k))+x[0]+3921069994&4294967295,N=O+(R<<20&4294967295|R>>>12),R=b+(O^k&(N^O))+x[5]+3593408605&4294967295,b=N+(R<<5&4294967295|R>>>27),R=k+(N^O&(b^N))+x[10]+38016083&4294967295,k=b+(R<<9&4294967295|R>>>23),R=O+(b^N&(k^b))+x[15]+3634488961&4294967295,O=k+(R<<14&4294967295|R>>>18),R=N+(k^b&(O^k))+x[4]+3889429448&4294967295,N=O+(R<<20&4294967295|R>>>12),R=b+(O^k&(N^O))+x[9]+568446438&4294967295,b=N+(R<<5&4294967295|R>>>27),R=k+(N^O&(b^N))+x[14]+3275163606&4294967295,k=b+(R<<9&4294967295|R>>>23),R=O+(b^N&(k^b))+x[3]+4107603335&4294967295,O=k+(R<<14&4294967295|R>>>18),R=N+(k^b&(O^k))+x[8]+1163531501&4294967295,N=O+(R<<20&4294967295|R>>>12),R=b+(O^k&(N^O))+x[13]+2850285829&4294967295,b=N+(R<<5&4294967295|R>>>27),R=k+(N^O&(b^N))+x[2]+4243563512&4294967295,k=b+(R<<9&4294967295|R>>>23),R=O+(b^N&(k^b))+x[7]+1735328473&4294967295,O=k+(R<<14&4294967295|R>>>18),R=N+(k^b&(O^k))+x[12]+2368359562&4294967295,N=O+(R<<20&4294967295|R>>>12),R=b+(N^O^k)+x[5]+4294588738&4294967295,b=N+(R<<4&4294967295|R>>>28),R=k+(b^N^O)+x[8]+2272392833&4294967295,k=b+(R<<11&4294967295|R>>>21),R=O+(k^b^N)+x[11]+1839030562&4294967295,O=k+(R<<16&4294967295|R>>>16),R=N+(O^k^b)+x[14]+4259657740&4294967295,N=O+(R<<23&4294967295|R>>>9),R=b+(N^O^k)+x[1]+2763975236&4294967295,b=N+(R<<4&4294967295|R>>>28),R=k+(b^N^O)+x[4]+1272893353&4294967295,k=b+(R<<11&4294967295|R>>>21),R=O+(k^b^N)+x[7]+4139469664&4294967295,O=k+(R<<16&4294967295|R>>>16),R=N+(O^k^b)+x[10]+3200236656&4294967295,N=O+(R<<23&4294967295|R>>>9),R=b+(N^O^k)+x[13]+681279174&4294967295,b=N+(R<<4&4294967295|R>>>28),R=k+(b^N^O)+x[0]+3936430074&4294967295,k=b+(R<<11&4294967295|R>>>21),R=O+(k^b^N)+x[3]+3572445317&4294967295,O=k+(R<<16&4294967295|R>>>16),R=N+(O^k^b)+x[6]+76029189&4294967295,N=O+(R<<23&4294967295|R>>>9),R=b+(N^O^k)+x[9]+3654602809&4294967295,b=N+(R<<4&4294967295|R>>>28),R=k+(b^N^O)+x[12]+3873151461&4294967295,k=b+(R<<11&4294967295|R>>>21),R=O+(k^b^N)+x[15]+530742520&4294967295,O=k+(R<<16&4294967295|R>>>16),R=N+(O^k^b)+x[2]+3299628645&4294967295,N=O+(R<<23&4294967295|R>>>9),R=b+(O^(N|~k))+x[0]+4096336452&4294967295,b=N+(R<<6&4294967295|R>>>26),R=k+(N^(b|~O))+x[7]+1126891415&4294967295,k=b+(R<<10&4294967295|R>>>22),R=O+(b^(k|~N))+x[14]+2878612391&4294967295,O=k+(R<<15&4294967295|R>>>17),R=N+(k^(O|~b))+x[5]+4237533241&4294967295,N=O+(R<<21&4294967295|R>>>11),R=b+(O^(N|~k))+x[12]+1700485571&4294967295,b=N+(R<<6&4294967295|R>>>26),R=k+(N^(b|~O))+x[3]+2399980690&4294967295,k=b+(R<<10&4294967295|R>>>22),R=O+(b^(k|~N))+x[10]+4293915773&4294967295,O=k+(R<<15&4294967295|R>>>17),R=N+(k^(O|~b))+x[1]+2240044497&4294967295,N=O+(R<<21&4294967295|R>>>11),R=b+(O^(N|~k))+x[8]+1873313359&4294967295,b=N+(R<<6&4294967295|R>>>26),R=k+(N^(b|~O))+x[15]+4264355552&4294967295,k=b+(R<<10&4294967295|R>>>22),R=O+(b^(k|~N))+x[6]+2734768916&4294967295,O=k+(R<<15&4294967295|R>>>17),R=N+(k^(O|~b))+x[13]+1309151649&4294967295,N=O+(R<<21&4294967295|R>>>11),R=b+(O^(N|~k))+x[4]+4149444226&4294967295,b=N+(R<<6&4294967295|R>>>26),R=k+(N^(b|~O))+x[11]+3174756917&4294967295,k=b+(R<<10&4294967295|R>>>22),R=O+(b^(k|~N))+x[2]+718787259&4294967295,O=k+(R<<15&4294967295|R>>>17),R=N+(k^(O|~b))+x[9]+3951481745&4294967295,I.g[0]=I.g[0]+b&4294967295,I.g[1]=I.g[1]+(O+(R<<21&4294967295|R>>>11))&4294967295,I.g[2]=I.g[2]+O&4294967295,I.g[3]=I.g[3]+k&4294967295}s.prototype.v=function(I,b){b===void 0&&(b=I.length);const N=b-this.blockSize,x=this.C;let O=this.h,k=0;for(;k<b;){if(O==0)for(;k<=N;)o(this,I,k),k+=this.blockSize;if(typeof I=="string"){for(;k<b;)if(x[O++]=I.charCodeAt(k++),O==this.blockSize){o(this,x),O=0;break}}else for(;k<b;)if(x[O++]=I[k++],O==this.blockSize){o(this,x),O=0;break}}this.h=O,this.o+=b},s.prototype.A=function(){var I=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);I[0]=128;for(var b=1;b<I.length-8;++b)I[b]=0;b=this.o*8;for(var N=I.length-8;N<I.length;++N)I[N]=b&255,b/=256;for(this.v(I),I=Array(16),b=0,N=0;N<4;++N)for(let x=0;x<32;x+=8)I[b++]=this.g[N]>>>x&255;return I};function u(I,b){var N=m;return Object.prototype.hasOwnProperty.call(N,I)?N[I]:N[I]=b(I)}function f(I,b){this.h=b;const N=[];let x=!0;for(let O=I.length-1;O>=0;O--){const k=I[O]|0;x&&k==b||(N[O]=k,x=!1)}this.g=N}var m={};function p(I){return-128<=I&&I<128?u(I,function(b){return new f([b|0],b<0?-1:0)}):new f([I|0],I<0?-1:0)}function y(I){if(isNaN(I)||!isFinite(I))return S;if(I<0)return K(y(-I));const b=[];let N=1;for(let x=0;I>=N;x++)b[x]=I/N|0,N*=4294967296;return new f(b,0)}function E(I,b){if(I.length==0)throw Error("number format error: empty string");if(b=b||10,b<2||36<b)throw Error("radix out of range: "+b);if(I.charAt(0)=="-")return K(E(I.substring(1),b));if(I.indexOf("-")>=0)throw Error('number format error: interior "-" character');const N=y(Math.pow(b,8));let x=S;for(let k=0;k<I.length;k+=8){var O=Math.min(8,I.length-k);const R=parseInt(I.substring(k,k+O),b);O<8?(O=y(Math.pow(b,O)),x=x.j(O).add(y(R))):(x=x.j(N),x=x.add(y(R)))}return x}var S=p(0),w=p(1),P=p(16777216);r=f.prototype,r.m=function(){if(J(this))return-K(this).m();let I=0,b=1;for(let N=0;N<this.g.length;N++){const x=this.i(N);I+=(x>=0?x:4294967296+x)*b,b*=4294967296}return I},r.toString=function(I){if(I=I||10,I<2||36<I)throw Error("radix out of range: "+I);if(Q(this))return"0";if(J(this))return"-"+K(this).toString(I);const b=y(Math.pow(I,6));var N=this;let x="";for(;;){const O=de(N,b).g;N=ee(N,O.j(b));let k=((N.g.length>0?N.g[0]:N.h)>>>0).toString(I);if(N=O,Q(N))return k+x;for(;k.length<6;)k="0"+k;x=k+x}},r.i=function(I){return I<0?0:I<this.g.length?this.g[I]:this.h};function Q(I){if(I.h!=0)return!1;for(let b=0;b<I.g.length;b++)if(I.g[b]!=0)return!1;return!0}function J(I){return I.h==-1}r.l=function(I){return I=ee(this,I),J(I)?-1:Q(I)?0:1};function K(I){const b=I.g.length,N=[];for(let x=0;x<b;x++)N[x]=~I.g[x];return new f(N,~I.h).add(w)}r.abs=function(){return J(this)?K(this):this},r.add=function(I){const b=Math.max(this.g.length,I.g.length),N=[];let x=0;for(let O=0;O<=b;O++){let k=x+(this.i(O)&65535)+(I.i(O)&65535),R=(k>>>16)+(this.i(O)>>>16)+(I.i(O)>>>16);x=R>>>16,k&=65535,R&=65535,N[O]=R<<16|k}return new f(N,N[N.length-1]&-2147483648?-1:0)};function ee(I,b){return I.add(K(b))}r.j=function(I){if(Q(this)||Q(I))return S;if(J(this))return J(I)?K(this).j(K(I)):K(K(this).j(I));if(J(I))return K(this.j(K(I)));if(this.l(P)<0&&I.l(P)<0)return y(this.m()*I.m());const b=this.g.length+I.g.length,N=[];for(var x=0;x<2*b;x++)N[x]=0;for(x=0;x<this.g.length;x++)for(let O=0;O<I.g.length;O++){const k=this.i(x)>>>16,R=this.i(x)&65535,We=I.i(O)>>>16,$e=I.i(O)&65535;N[2*x+2*O]+=R*$e,ae(N,2*x+2*O),N[2*x+2*O+1]+=k*$e,ae(N,2*x+2*O+1),N[2*x+2*O+1]+=R*We,ae(N,2*x+2*O+1),N[2*x+2*O+2]+=k*We,ae(N,2*x+2*O+2)}for(I=0;I<b;I++)N[I]=N[2*I+1]<<16|N[2*I];for(I=b;I<2*b;I++)N[I]=0;return new f(N,0)};function ae(I,b){for(;(I[b]&65535)!=I[b];)I[b+1]+=I[b]>>>16,I[b]&=65535,b++}function se(I,b){this.g=I,this.h=b}function de(I,b){if(Q(b))throw Error("division by zero");if(Q(I))return new se(S,S);if(J(I))return b=de(K(I),b),new se(K(b.g),K(b.h));if(J(b))return b=de(I,K(b)),new se(K(b.g),b.h);if(I.g.length>30){if(J(I)||J(b))throw Error("slowDivide_ only works with positive integers.");for(var N=w,x=b;x.l(I)<=0;)N=ge(N),x=ge(x);var O=ve(N,1),k=ve(x,1);for(x=ve(x,2),N=ve(N,2);!Q(x);){var R=k.add(x);R.l(I)<=0&&(O=O.add(N),k=R),x=ve(x,1),N=ve(N,1)}return b=ee(I,O.j(b)),new se(O,b)}for(O=S;I.l(b)>=0;){for(N=Math.max(1,Math.floor(I.m()/b.m())),x=Math.ceil(Math.log(N)/Math.LN2),x=x<=48?1:Math.pow(2,x-48),k=y(N),R=k.j(b);J(R)||R.l(I)>0;)N-=x,k=y(N),R=k.j(b);Q(k)&&(k=w),O=O.add(k),I=ee(I,R)}return new se(O,I)}r.B=function(I){return de(this,I).h},r.and=function(I){const b=Math.max(this.g.length,I.g.length),N=[];for(let x=0;x<b;x++)N[x]=this.i(x)&I.i(x);return new f(N,this.h&I.h)},r.or=function(I){const b=Math.max(this.g.length,I.g.length),N=[];for(let x=0;x<b;x++)N[x]=this.i(x)|I.i(x);return new f(N,this.h|I.h)},r.xor=function(I){const b=Math.max(this.g.length,I.g.length),N=[];for(let x=0;x<b;x++)N[x]=this.i(x)^I.i(x);return new f(N,this.h^I.h)};function ge(I){const b=I.g.length+1,N=[];for(let x=0;x<b;x++)N[x]=I.i(x)<<1|I.i(x-1)>>>31;return new f(N,I.h)}function ve(I,b){const N=b>>5;b%=32;const x=I.g.length-N,O=[];for(let k=0;k<x;k++)O[k]=b>0?I.i(k+N)>>>b|I.i(k+N+1)<<32-b:I.i(k+N);return new f(O,I.h)}s.prototype.digest=s.prototype.A,s.prototype.reset=s.prototype.u,s.prototype.update=s.prototype.v,sS=s,f.prototype.add=f.prototype.add,f.prototype.multiply=f.prototype.j,f.prototype.modulo=f.prototype.B,f.prototype.compare=f.prototype.l,f.prototype.toNumber=f.prototype.m,f.prototype.toString=f.prototype.toString,f.prototype.getBits=f.prototype.i,f.fromNumber=y,f.fromString=E,ts=f}).apply(typeof T0<"u"?T0:typeof self<"u"?self:typeof window<"u"?window:{});var Fc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
...
Total Duration: ${y-E}ms`),W.resolve({didRun:!0,sequenceNumbersCollected:o,targetsRemoved:u,documentsRemoved:S}))))}}function t5(r,e){return new e5(r,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $t="WebChannelConnection",Ml=(r,e,n)=>{r.listen(e,(s=>{try{n(s)}catch(o){setTimeout((()=>{throw o}),0)}}))};class ao extends w5{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!ao.c_){const e=uS();Ml(e,lS.STAT_EVENT,(n=>{n.stat===Pm.PROXY?le($t,"STAT_EVENT: detected buffering proxy"):n.stat===Pm.NOPROXY&&le($t,"STAT_EVENT: detected no buffering proxy")})),ao.c_=!0}}zo(e,n,s,o,u){const f=Zm();return new Promise(((m,p)=>{const y=new aS;y.setWithCredentials(!0),y.listenOnce(oS.COMPLETE,(()=>{try{switch(y.getLastErrorCode()){case nh.NO_ERROR:const S=y.getResponseJson();le($t,`XHR for RPC '${e}' ${f} received:`,JSON.stringify(S)),m(S);break;case nh.TIMEOUT:le($t,`RPC '${e}' ${f} timed out`),p(new he(te.DEADLINE_EXCEEDED,"Request time out"));break;case nh.HTTP_ERROR:const w=y.getStatus();if(le($t,`RPC '${e}' ${f} failed with status:`,w,"response text:",y.getResponseText()),w>0){let P=y.getResponseJson();Array.isArray(P)&&(P=P[0]);const Q=P==null?void 0:P.error;if(Q&&Q.status&&Q.message){const J=(function(ee){const ae=ee.toLowerCase().replace(/_/g,"-");return Object.values(te).indexOf(ae)>=0?ae:te.UNKNOWN})(Q.status);p(new he(J,Q.message))}else p(new he(te.UNKNOWN,"Server responded with status "+y.getStatus()))}else p(new he(te.UNAVAILABLE,"Connection failed."));break;default:Ae(9055,{l_:e,streamId:f,h_:y.getLastErrorCode(),P_:y.getLastError()})}}finally{le($t,`RPC '${e}' ${f} completed.`)}}));const E=JSON.stringify(o);le($t,`RPC '${e}' ${f} sending request:`,o),y.send(n,"POST",E,s,15)}))}T_(e,n,s){const o=Zm(),u=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],f=this.createWebChannelTransport(),m={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},p=this.longPollingOptions.timeoutSeconds;p!==void 0&&(m.longPollingTimeout=Math.round(1e3*p)),this.useFetchStreams&&(m.useFetchStreams=!0),this.Go(m.initMessageHeaders,n,s),m.encodeInitMessageHeaders=!0;const y=u.join("");le($t,`Creating RPC '${e}' stream ${o}: ${y}`,m);const E=f.createWebChannel(y,m);this.E_(E);let S=!1,w=!1;const P=new R5({Jo:Q=>{w?le($t,`Not sending because RPC '${e}' stream ${o} is closed:`,Q):(S||(le($t,`Opening RPC '${e}' stream ${o} transport.`),E.open(),S=!0),le($t,`RPC '${e}' stream ${o} sending:`,Q),E.send(Q))},Ho:()=>E.close()});return Ml(E,kl.EventType.OPEN,(()=>{w||(le($t,`RPC '${e}' stream ${o} transport opened.`),P.i_())})),Ml(E,kl.EventType.CLOSE,(()=>{w||(w=!0,le($t,`RPC '${e}' stream ${o} transport closed`),P.o_(),this.I_(E))})),Ml(E,kl.EventType.ERROR,(Q=>{w||(w=!0,ea($t,`RPC '${e}' stream ${o} transport errored. Name:`,Q.name,"Message:",Q.message),P.o_(new he(te.UNAVAILABLE,"The operation could not be completed")))})),Ml(E,kl.EventType.MESSAGE,(Q=>{var J;if(!w){const K=Q.data[0];lt(!!K,16349);const ee=K,ae=(ee==null?void 0:ee.error)||((J=ee[0])==null?void 0:J.error);if(ae){le($t,`RPC '${e}' stream ${o} received error:`,ae);const se=ae.status;let de=(function(I){const b=Rt[I];if(b!==void 0)return kS(b)})(se),ge=ae.message;se==="NOT_FOUND"&&ge.includes("database")&&ge.includes("does not exist")&&ge.includes(this.databaseId.database)&&ea(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),de===void 0&&(de=te.INTERNAL,ge="Unknown error status: "+se+" with message "+ae.message),w=!0,P.o_(new he(de,ge)),E.close()}else le($t,`RPC '${e}' stream ${o} received:`,K),P.__(K)}})),ao.u_(),setTimeout((()=>{P.s_()}),0),P}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}E_(e){this.a_.push(e)}I_(e){this.a_=this.a_.filter((n=>n===e))}Go(e,n,s){super.Go(e,n,s),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return cS()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ni{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let s;try{s=ni.makeFromUrl(e,n)}catch{return new ni(e,"")}if(s.path==="")return s;throw MM(e)}static makeFromUrl(e,n){let s=null;const o="([A-Za-z0-9.\\-_]+)";function u(de){de.path.charAt(de.path.length-1)==="/"&&(de.path_=de.path_.slice(0,-1))}const f="(/(.*))?$",m=new RegExp("^gs://"+o+f,"i"),p={bucket:1,path:3};function y(de){de.path_=decodeURIComponent(de.path)}const E="v[A-Za-z0-9_]+",S=n.replace(/[.]/g,"\\."),w="(/([^?#]*).*)?$",P=new RegExp(`^https?://${S}/${E}/b/${o}/o${w}`,"i"),Q={bucket:1,path:3},J=n===vA?"(?:storage.googleapis.com|storage.cloud.google.com)":n,K="([^?#]*)",ee=new RegExp(`^https?://${J}/${o}/${K}`,"i"),se=[{regex:m,indices:p,postModify:u},{regex:P,indices:Q,postModify:y},{regex:ee,indices:{bucket:1,path:2},postModify:y}];for(let de=0;de<se.length;de++){const ge=se[de],ve=ge.regex.exec(e);if(ve){const I=ve[ge.indices.bucket];let b=ve[ge.indices.path];b||(b=""),s=new ni(I,b),ge.postModify(s);break}}if(s==null)throw OM(e);return s}}class VM{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kM(r,e,n){let s=1,o=null,u=null,f=!1,m=0;function p(){return m===2}let y=!1;function E(...K){y||(y=!0,e.apply(null,K))}function S(K){o=setTimeout(()=>{o=null,r(P,p())},K)}function w(){u&&clearTimeout(u)}function P(K,...ee){if(y){w();return}if(K){w(),E.call(null,K,...ee);return}if(p()||f){w(),E.call(null,K,...ee);return}s<64&&(s*=2);let se;m===1?(m=2,se=0):se=(s+Math.random())*1e3,S(se)}let Q=!1;function J(K){Q||(Q=!0,w(),!y&&(o!==null?(K||(m=2),clearTimeout(o),S(0)):K||(m=1)))}return S(0),u=setTimeout(()=>{f=!0,J(!0)},n),J}function LM(r){r(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TA="storage";function XM(r=iu(),e){r=Ut(r);const s=cr(r,TA).getImmediate({identifier:e}),o=hp("storage");return o&&ZM(s,...o),s}function ZM(r,e,n,s={}){$M(r,e,n,s)}function JM(r,{instanceIdentifier:e}){const n=r.getProvider("app").getImmediate(),s=r.getProvider("auth-internal"),o=r.getProvider("app-check-internal");return new QM(n,s,o,e,ia)}function WM(){jn(new wn(TA,JM,"PUBLIC").setMultipleInstances(!0)),Jt(TE,SE,""),Jt(TE,SE,"esm2020")}WM();const ex={apiKey:void 0,authDomain:void 0,databaseURL:void 0,projectId:void 0,storageBucket:void 0,messagingSenderId:void 0,appId:void 0,measurementId:void 0},fu=tT(ex);typeof window<"u"&&rD(fu);const bm=U2(fu),SA=mM(fu);gD(fu);XM(fu);const AA=B.createContext(void 0),tx=({children:r})=>{const[e,n]=B.useState(null),[s,o]=B.useState(!0);B.useEffect(()=>RC(bm,p=>{n(p),o(!1)}),[]);const u=async(m,p)=>{await AC(bm,m,p)},f=async()=>{await IC(bm)};return F.jsx(AA.Provider,{value:{user:e,loading:s,signIn:u,logout:f},children:!s&&r})},Xp=()=>{const r=B.useContext(AA);if(r===void 0)throw new Error("useAuth must be used within an AuthProvider");return r},nx=()=>{const{user:r,loading:e}=Xp();return e?F.jsx("div",{className:"flex h-screen w-screen items-center justify-center","data-cy":"auth-loading",children:F.jsx("span",{className:"loading loading-spinner loading-lg"})}):r?F.jsx(c1,{}):F.jsx(u1,{to:"/",replace:!0})};function ix({adminLoginOnClick:r}){const[e,n]=B.useState(""),[s,o]=B.useState(""),{signIn:u}=Xp(),f=async()=>{try{await u(e,s),r()}catch(m){console.error("Login failed:",m),alert("Invalid credentials")}};return F.jsx("div",{className:"fixed inset-0 flex items-center justify-center backdrop-blur-xs z-50","data-cy":"login-modal",children:F.jsxs("fieldset",{className:"fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4",children:[F.jsxs("div",{className:"flex flex-row justify-between",children:[F.jsx("h1",{className:"text-xl font-bold",children:"Login"}),F.jsx("button",{className:"btn btn-square",onClick:r,"data-cy":"login-close",children:"X"})]}),F.jsx("p",{children:"For admins only"}),F.jsx("label",{className:"label",children:"Email"}),F.jsx("input",{type:"email",className:"input",placeholder:"Email",value:e,onChange:m=>n(m.target.value),"data-cy":"login-email"}),F.jsx("label",{className:"label",children:"Password"}),F.jsx("input",{type:"password",className:"input",placeholder:"Password",value:s,onChange:m=>o(m.target.value),"data-cy":"login-password"}),F.jsx("button",{className:"btn btn-outline mt-4",onClick:f,"data-cy":"login-submit",children:"Login"})]})})}const rx=({children:r})=>{const{user:e,logout:n}=Xp(),s=eu(),[o,u]=B.useState(!1),[f,m]=B.useState(!1),p=()=>{u(!o)},y=()=>{m(!f)},E=async()=>{try{await n(),m(!1)}catch(P){console.error("Logout failed:",P)}},S=P=>{if(s(P),window.innerWidth<768){const Q=document.getElementById("my-drawer");Q&&(Q.checked=!1)}},w=[{name:"Store",path:"/",icon:F.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor",className:"my-1.5 inline-block size-6",children:F.jsx("path",{d:"M2.25 2.25a.75.75 0 0 0 0 1.5h1.386c.17 0 .318.114.362.278l2.558 9.592a3.752 3.752 0 0 0-2.806 3.63c0 .414.336.75.75.75h15.75a.75.75 0 0 0 0-1.5H5.378A2.25 2.25 0 0 1 7.5 15h11.218a.75.75 0 0 0 .674-.421 60.358 60.358 0 0 0 2.96-7.228.75.75 0 0 0-.525-.965A60.864 60.864 0 0 0 5.68 4.509l-.232-.867A1.875 1.875 0 0 0 3.636 2.25H2.25ZM3.75 20.25a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM16.5 20.25a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Z"})})},{name:"Finance",path:"/finance",icon:F.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor",className:"my-1.5 inline-block size-6",children:[F.jsx("path",{fillRule:"evenodd",d:"M5.625 1.5H9a3.75 3.75 0 0 1 3.75 3.75v1.875c0 1.036.84 1.875 1.875 1.875H16.5a3.75 3.75 0 0 1 3.75 3.75v7.875c0 1.035-.84 1.875-1.875 1.875H5.625a1.875 1.875 0 0 1-1.875-1.875V3.375c0-1.036.84-1.875 1.875-1.875ZM9.75 17.25a.75.75 0 0 0-1.5 0V18a.75.75 0 0 0 1.5 0v-.75Zm2.25-3a.75.75 0 0 1 .75.75v3a.75.75 0 0 1-1.5 0v-3a.75.75 0 0 1 .75-.75Zm3.75-1.5a.75.75 0 0 0-1.5 0V18a.75.75 0 0 0 1.5 0v-5.25Z",clipRule:"evenodd"}),F.jsx("path",{d:"M14.25 5.25a5.23 5.23 0 0 0-1.279-3.434 9.768 9.768 0 0 1 6.963 6.963A5.23 5.23 0 0 0 16.5 7.5h-1.875a.375.375 0 0 1-.375-.375V5.25Z"})]})},{name:"Inventory",path:"/inventory",icon:F.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor",className:"my-1.5 inline-block size-6",children:[F.jsx("path",{d:"M21 6.375c0 2.692-4.03 4.875-9 4.875S3 9.067 3 6.375 7.03 1.5 12 1.5s9 2.183 9 4.875Z"}),F.jsx("path",{d:"M12 12.75c2.685 0 5.19-.586 7.078-1.609a8.283 8.283 0 0 0 1.897-1.384c.016.121.025.244.025.368C21 12.817 16.97 15 12 15s-9-2.183-9-4.875c0-.124.009-.247.025-.368a8.285 8.285 0 0 0 1.897 1.384C6.809 12.164 9.315 12.75 12 12.75Z"}),F.jsx("path",{d:"M12 16.5c2.685 0 5.19-.586 7.078-1.609a8.282 8.282 0 0 0 1.897-1.384c.016.121.025.244.025.368 0 2.692-4.03 4.875-9 4.875s-9-2.183-9-4.875c0-.124.009-.247.025-.368a8.284 8.284 0 0 0 1.897 1.384C6.809 15.914 9.315 16.5 12 16.5Z"}),F.jsx("path",{d:"M12 20.25c2.685 0 5.19-.586 7.078-1.609a8.282 8.282 0 0 0 1.897-1.384c.016.121.025.244.025.368 0 2.692-4.03 4.875-9 4.875s-9-2.183-9-4.875c0-.124.009-.247.025-.368a8.284 8.284 0 0 0 1.897 1.384C6.809 19.664 9.315 20.25 12 20.25Z"})]})},{name:"POS",path:"/pos",icon:F.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor",className:"my-1.5 inline-block size-6",children:F.jsx("path",{fillRule:"evenodd",d:"M6.32 1.827a49.255 49.255 0 0 1 11.36 0c1.497.174 2.57 1.46 2.57 2.93V19.5a3 3 0 0 1-3 3H6.75a3 3 0 0 1-3-3V4.757c0-1.47 1.073-2.756 2.57-2.93ZM7.5 11.25a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75H8.25a.75.75 0 0 1-.75-.75v-.008Zm.75 1.5a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75V13.5a.75.75 0 0 0-.75-.75H8.25Zm-.75 3a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75H8.25a.75.75 0 0 1-.75-.75v-.008Zm.75 1.5a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75V18a.75.75 0 0 0-.75-.75H8.25Zm1.748-6a.75.75 0 0 1 .75-.75h.007a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.007a.75.75 0 0 1-.75-.75v-.008Zm.75 1.5a.75.75 0 0 0-.75.75v.008c0 .414.335.75.75.75h.007a.75.75 0 0 0 .75-.75V13.5a.75.75 0 0 0-.75-.75h-.007Zm-.75 3a.75.75 0 0 1 .75-.75h.007a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.007a.75.75 0 0 1-.75-.75v-.008Zm.75 1.5a.75.75 0 0 0-.75.75v.008c0 .414.335.75.75.75h.007a.75.75 0 0 0 .75-.75V18a.75.75 0 0 0-.75-.75h-.007Zm1.754-6a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.008a.75.75 0 0 1-.75-.75v-.008Zm.75 1.5a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75V13.5a.75.75 0 0 0-.75-.75h-.008Zm-.75 3a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.008a.75.75 0 0 1-.75-.75v-.008Zm.75 1.5a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75V18a.75.75 0 0 0-.75-.75h-.008Zm1.748-6a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.008a.75.75 0 0 1-.75-.75v-.008Zm.75 1.5a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75V13.5a.75.75 0 0 0-.75-.75h-.008Zm-8.25-6A.75.75 0 0 1 8.25 6h7.5a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-7.5a.75.75 0 0 1-.75-.75v-.75Zm9 9a.75.75 0 0 0-1.5 0V18a.75.75 0 0 0 1.5 0v-2.25Z",clipRule:"evenodd"})})},{name:"Admin",path:"/admin",icon:F.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor",className:"my-1.5 inline-block size-6",children:[F.jsx("path",{fillRule:"evenodd",d:"M12 6.75a5.25 5.25 0 0 1 6.775-5.025.75.75 0 0 1 .313 1.248l-3.32 3.319c.063.475.276.934.641 1.299.365.365.824.578 1.3.64l3.318-3.319a.75.75 0 0 1 1.248.313 5.25 5.25 0 0 1-5.472 6.756c-1.018-.086-1.87.1-2.309.634L7.344 21.3A3.298 3.298 0 1 1 2.7 16.657l8.684-7.151c.533-.44.72-1.291.634-2.309A5.342 5.342 0 0 1 12 6.75ZM4.117 19.125a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.008a.75.75 0 0 1-.75-.75v-.008Z",clipRule:"evenodd"}),F.jsx("path",{d:"m10.076 8.64-2.201-2.2V4.874a.75.75 0 0 0-.364-.643l-3.75-2.25a.75.75 0 0 0-.916.113l-.75.75a.75.75 0 0 0-.113.916l2.25 3.75a.75.75 0 0 0 .643.364h1.564l2.062 2.062 1.575-1.297Z"}),F.jsx("path",{fillRule:"evenodd",d:"m12.556 17.329 4.183 4.182a3.375 3.375 0 0 0 4.773-4.773l-3.306-3.305a6.803 6.803 0 0 1-1.53.043c-.394-.034-.682-.006-.867.042a.589.589 0 0 0-.167.063l-3.086 3.748Zm3.414-1.36a.75.75 0 0 1 1.06 0l1.875 1.876a.75.75 0 1 1-1.06 1.06L15.97 17.03a.75.75 0 0 1 0-1.06Z",clipRule:"evenodd"})]})}];return F.jsxs("div",{className:"drawer md:drawer-open",children:[F.jsx("input",{id:"my-drawer",type:"checkbox",className:"drawer-toggle","data-cy":"drawer-checkbox"}),F.jsxs("div",{className:"drawer-content flex flex-col",children:[F.jsxs("nav",{className:"navbar sticky top-0 z-50 p-2 bg-white/60 dark:bg-base-100/60 backdrop-blur-xl w-full h-fit justify-between flex flex-col sm:flex-row",children:[F.jsxs("div",{className:"flex h-fit w-full items-center flex-row justify-spaced",children:[F.jsx("div",{className:"flex-none",children:e!==null&&F.jsx("label",{htmlFor:"my-drawer","aria-label":"open sidebar",className:"btn btn-square btn-ghost","data-cy":"drawer-toggle",children:F.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",strokeLinejoin:"round",strokeLinecap:"round",strokeWidth:"2",fill:"none",stroke:"currentColor",className:"my-1.5 inline-block size-6",children:[F.jsx("path",{d:"M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"}),F.jsx("path",{d:"M9 4v16"}),F.jsx("path",{d:"M14 10l2 2l-2 2"})]})})}),F.jsx("button",{className:"btn btn-ghost text-xl grow",onClick:()=>s("/"),"data-cy":"navbar-home",children:"🚀 Detonate Fundraising 🚀"})]}),e==null?F.jsx("button",{className:"btn btn-ghost",onClick:p,"data-cy":"admin-button",children:"Admin"}):F.jsxs("button",{className:"btn btn-ghost",onClick:y,"data-cy":"admin-user-button",children:["Admin: ",e.displayName||e.email]})]}),F.jsx("main",{className:"flex-1",children:r})]}),e!==null&&F.jsxs("div",{className:"drawer-side is-drawer-close:overflow-visible z-50",children:[F.jsx("label",{htmlFor:"my-drawer","aria-label":"close sidebar",className:"drawer-overlay"}),F.jsx("div",{className:"flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-16 is-drawer-open:w-38",children:F.jsx("ul",{className:"menu w-full grow",children:w.map(P=>F.jsx("li",{children:F.jsxs("button",{onClick:()=>S(P.path),className:"is-drawer-close:tooltip is-drawer-close:tooltip-right","data-tip":P.name,"data-cy":`drawer-link-${P.name.toLowerCase()}`,children:[P.icon,F.jsx("span",{className:"is-drawer-close:hidden",children:P.name})]})},P.name))})})]}),o&&F.jsx(ix,{adminLoginOnClick:p}),f&&F.jsx("div",{className:"fixed inset-0 flex items-center justify-center backdrop-blur-xs z-50","data-cy":"logout-modal",children:F.jsxs("div",{className:"card bg-base-100 p-7 flex flex-col gap-5 border border-base-300 shadow-xl",children:[F.jsx("h1",{className:"text-center",children:"Confirm Logout?"}),F.jsxs("div",{className:"flex flex-row gap-4",children:[F.jsx("button",{className:"btn btn-error",onClick:E,"data-cy":"logout-confirm",children:"Logout"}),F.jsx("button",{className:"btn btn-outline",onClick:y,"data-cy":"logout-cancel",children:"Cancel"})]})]})})]})};function sx({item:r,storeItemOnClick:e}){return F.jsx(F.Fragment,{children:F.jsxs("div",{className:"card bg-base-100 shadow-sm cursor-pointer",onClick:e,"data-cy":`store-item-card-${r.id}`,children:[F.jsx("figure",{children:F.jsx("img",{src:r.imageURL,loading:"lazy",alt:r.name})}),F.jsxs("div",{className:"card-body",children:[F.jsx("h2",{className:"card-title",children:r.name}),F.jsx("p",{children:r.description})]})]})})}function ax(){const[r,e]=B.useState([]),[n,s]=B.useState(!0),o=eu(),u=f=>{o(`/${f.id}`,{state:{product:f}})};return B.useEffect(()=>{(async()=>{try{const p=(await AM(fM(SA,"products"))).docs.map(y=>({id:y.id,...y.data()}));e(p)}catch(m){console.error("Error fetching products: ",m)}finally{s(!1)}})()},[]),F.jsx("div",{className:"flex flex-col relative m-4",children:n?F.jsx("div",{className:"p-10 text-center","data-cy":"storefront-loading",children:"Loading products..."}):F.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4","data-cy":"storefront-grid",children:r.map(f=>F.jsx(sx,{item:f,storeItemOnClick:()=>u(f)},f.id))})})}function ox(){var E;const{productId:r}=Qw(),e=ai(),n=eu(),s=(E=e.state)==null?void 0:E.product,[o,u]=B.useState(s&&s.id===r?s:null),[f,m]=B.useState(!(s&&s.id===r)),p=o?[o.imageURL,...o.additionalImages||[]]:[],y=S=>{const w=document.getElementById(`slide-${S}`);w&&w.scrollIntoView({behavior:"smooth",block:"nearest",inline:"start"})};return B.useEffect(()=>{let S=!0;return(async()=>{if(!r){S&&(u(null),m(!1));return}if(s&&s.id===r){S&&(u(s),m(!1));return}S&&(u(null),m(!0));try{const P=dM(SA,"products",r),Q=await SM(P);if(!S)return;Q.exists()?u({id:Q.id,...Q.data()}):(u(null),console.error("No such product!"))}catch(P){S&&(u(null),console.error("Error fetching product: ",P))}finally{S&&m(!1)}})(),()=>{S=!1}},[r,s]),F.jsx("div",{className:"flex flex-col relative",children:F.jsxs("div",{className:"m-4",children:[F.jsx("button",{className:"btn btn-outline mb-4",onClick:()=>n("/"),"data-cy":"back-to-store",children:"← Back to Store"}),f?F.jsx("div",{className:"p-10 text-center","data-cy":"product-loading",children:"Loading product..."}):o?F.jsxs("div",{className:"flex flex-col md:flex-row gap-4","data-cy":"product-detail",children:[F.jsxs("div",{className:"flex flex-col basis-1/2",children:[F.jsx("div",{className:"carousel w-full rounded-2xl","data-cy":"product-carousel",children:p.map((S,w)=>F.jsxs("div",{id:`slide-${w}`,className:"carousel-item relative w-full","data-cy":`product-slide-${w}`,children:[F.jsx("img",{src:S,alt:`${o.name} - view ${w+1}`,className:"w-full"}),p.length>1&&F.jsxs("div",{className:"absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between",children:[F.jsx("button",{onClick:()=>y(w===0?p.length-1:w-1),className:"btn btn-circle","data-cy":"carousel-prev",children:"❮"}),F.jsx("button",{onClick:()=>y(w===p.length-1?0:w+1),className:"btn btn-circle","data-cy":"carousel-next",children:"❯"})]})]},w))}),p.length>1&&F.jsx("div",{className:"flex w-full justify-center gap-2 py-2",children:p.map((S,w)=>F.jsx("button",{onClick:()=>y(w),className:"btn btn-md rounded-xl","data-cy":`carousel-index-${w}`,children:w+1},w))})]}),F.jsxs("div",{className:"flex flex-col basis-1/2",children:[F.jsx("h1",{className:"card-title","data-cy":"product-name",children:o.name}),F.jsx("p",{"data-cy":"product-description",children:o.description})]})]}):F.jsx("div",{className:"p-10 text-center text-error","data-cy":"product-not-found",children:"Product not found."})]})})}const lx=()=>F.jsxs("div",{className:"flex h-full w-full flex-col items-center justify-center p-10",children:[F.jsx("h1",{className:"text-4xl font-bold",children:"Finance"}),F.jsx("p",{className:"mt-4 text-xl opacity-70",children:"This page is under construction."}),F.jsx("div",{className:"mt-8",children:F.jsx("span",{className:"loading loading-bars loading-lg"})})]}),ux=()=>F.jsxs("div",{className:"flex h-full w-full flex-col items-center justify-center p-10",children:[F.jsx("h1",{className:"text-4xl font-bold",children:"Inventory"}),F.jsx("p",{className:"mt-4 text-xl opacity-70",children:"This page is under construction."}),F.jsx("div",{className:"mt-8",children:F.jsx("span",{className:"loading loading-bars loading-lg"})})]}),cx=()=>F.jsxs("div",{className:"flex h-full w-full flex-col items-center justify-center p-10",children:[F.jsx("h1",{className:"text-4xl font-bold",children:"POS (Point of Sale)"}),F.jsx("p",{className:"mt-4 text-xl opacity-70",children:"This page is under construction."}),F.jsx("div",{className:"mt-8",children:F.jsx("span",{className:"loading loading-bars loading-lg"})})]}),hx=()=>F.jsxs("div",{className:"flex h-full w-full flex-col items-center justify-center p-10",children:[F.jsx("h1",{className:"text-4xl font-bold",children:"Admin Settings"}),F.jsx("p",{className:"mt-4 text-xl opacity-70",children:"This page is under construction."}),F.jsx("div",{className:"mt-8",children:F.jsx("span",{className:"loading loading-bars loading-lg"})})]});function fx(){return F.jsx(tx,{children:F.jsx("div",{className:"text-sm sm:text-base md:text-lg",children:F.jsx(L1,{children:F.jsx(rx,{children:F.jsxs(f1,{children:[F.jsx(Gr,{path:"/",element:F.jsx(ax,{})}),F.jsx(Gr,{path:"/:productId",element:F.jsx(ox,{})}),F.jsxs(Gr,{element:F.jsx(nx,{}),children:[F.jsx(Gr,{path:"/finance",element:F.jsx(lx,{})}),F.jsx(Gr,{path:"/inventory",element:F.jsx(ux,{})}),F.jsx(Gr,{path:"/pos",element:F.jsx(cx,{})}),F.jsx(Gr,{path:"/admin",element:F.jsx(hx,{})})]})]})})})})})}uw.createRoot(document.getElementById("root")).render(F.jsx(B.StrictMode,{children:F.jsx(fx,{})}));
