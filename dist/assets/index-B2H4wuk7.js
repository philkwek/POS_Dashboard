 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ni{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let s;try{s=ni.makeFromUrl(e,n)}catch{return new ni(e,"")}if(s.path==="")return s;throw MM(e)}static makeFromUrl(e,n){let s=null;const o="([A-Za-z0-9.\\-_]+)";function u(de){de.path.charAt(de.path.length-1)==="/"&&(de.path_=de.path_.slice(0,-1))}const f="(/(.*))?$",m=new RegExp("^gs://"+o+f,"i"),p={bucket:1,path:3};function y(de){de.path_=decodeURIComponent(de.path)}const E="v[A-Za-z0-9_]+",S=n.replace(/[.]/g,"\\."),N="(/([^?#]*).*)?$",U=new RegExp(`^https?://${S}/${E}/b/${o}/o${N}`,"i"),X={bucket:1,path:3},J=n===vA?"(?:storage.googleapis.com|storage.cloud.google.com)":n,K="([^?#]*)",ee=new RegExp(`^https?://${J}/${o}/${K}`,"i"),se=[{regex:m,indices:p,postModify:u},{regex:U,indices:X,postModify:y},{regex:ee,indices:{bucket:1,path:2},postModify:y}];for(let de=0;de<se.length;de++){const ge=se[de],ve=ge.regex.exec(e);if(ve){const R=ve[ge.indices.bucket];let b=ve[ge.indices.path];b||(b=""),s=new ni(R,b),ge.postModify(s);break}}if(s==null)throw OM(e);return s}}class VM{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kM(r,e,n){let s=1,o=null,u=null,f=!1,m=0;function p(){return m===2}let y=!1;function E(...K){y||(y=!0,e.apply(null,K))}function S(K){o=setTimeout(()=>{o=null,r(U,p())},K)}function N(){u&&clearTimeout(u)}function U(K,...ee){if(y){N();return}if(K){N(),E.call(null,K,...ee);return}if(p()||f){N(),E.call(null,K,...ee);return}s<64&&(s*=2);let se;m===1?(m=2,se=0):se=(s+Math.random())*1e3,S(se)}let X=!1;function J(K){X||(X=!0,N(),!y&&(o!==null?(K||(m=2),clearTimeout(o),S(0)):K||(m=1)))}return S(0),u=setTimeout(()=>{f=!0,J(!0)},n),J}function LM(r){r(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
